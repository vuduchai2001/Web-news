                            ...
                            <div class="row d-flex justify-content-between align-items-center">
                                <div class="header-info-left">
                                    <ul>     
                                        ...
                                        <li><img src="assets/img/icon/header_icon1.png" alt="">Thứ 4, 08/03/2022</li>
                                    </ul>
                                </div>
                   ...
                   <div class="container">
                        <div class="row d-flex align-items-center">
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-3">
                                <div class="logo">
                                    <a href="trang-chu"><img src="assets/img/logo/logo.png" alt=""></a>
                                </div>
                            </div>
        ...
        <div class="container">
            <div class="trending-main">
                ...
                <div class="row">
                    <div class="col-lg-8">
                        ...
                        <!-- <div class="trending-top mb-30">
                            <div class="trend-top-img">
                                ...
                                <div class="trend-top-cap">
                                    ...
                                    <h2><a href="details.html?id=">Welcome To The Best Model Winner<br> Contest At Look of the year</a></h2>
                                </div>
                            </div>
                        </div> -->
                        
                        <c:forEach items="${a.listTrendingTop }" var="i">
                        	<div class="trending-top mb-30">
                            <div class="trend-top-img">
                                <img src=${i.image } alt="">
                                <div class="trend-top-cap">
                                    <span>${i.category }</span>
                                    <h2><a href="details?id=${i.ID }">${i.caption}</a></h2>
                                </div>
                            </div>
                        </div>
                        </c:forEach>
                        <!-- Trending Bottom -->
                         ...
                         <div class="trending-bottom">
                            <div class="row">
                            	<c:forEach items="${a.listTrendingBottom }" var="i">
                            		<div class="col-lg-4">
                                <div class="single-bottom mb-35">
                                    ...
                                    <div class="trend-bottom-cap">
                                        ...
                                        <h4><a href="details?id=${i.ID }">${i.caption }</a></h4>
                                    </div>
                                </div>
                                </div>
                            	</c:forEach>
                                ...
                                <div class="single-bottom mb-35">
                                    ...
                                    <div class="trend-bottom-cap">
                                        ...
                                        <h4><a href="details.html">Get the Illusion of Fuller Lashes by âMascng.â</a></h4>
                                    </div>
                                </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="single-bottom mb-35">
                                        ...
                                        <div class="trend-bottom-cap">
                                            ...
                                            <h4><h4><a href="details.html">Get the Illusion of Fuller Lashes by âMascng.â</a></h4></h4>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                    ...
                    <!-- Right content -->
                    <div class="col-lg-4">
                    <c:forEach items="${a.listTrendingRight }" var="b">
                    	<div class="trand-right-single d-flex">
                            ...
                            <div class="trand-right-cap">
                                ...
                                <h4><a href="details?id=${b.ID }">${b.caption}</a></h4>
                            </div>
                        </div>
                    </c:forEach>
                        <!--  <div class="trand-right-single d-flex">
        ...
        <div class="container">
           <div class="weekly-wrapper">
                ...
                <div class="row">
                    ...
                    <c:forEach items="${a.listWeeklyTopNews }" var="b">
                     ...
                     <!-- <div class="weekly-news-active dot-style d-flex dot-style">
                            <div class="weekly-single">
                                <div class="weekly-img">
                                    <img src="assets/img/trending/right1.jpg" height = "431.66px" alt="">
                                </div>
                                <div class="weekly-caption">
                    ...
                    <div class="col-12">
                        ...
                        <div class="tab-content" id="nav-tabContent">
                            ...
                            <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                                <div class="whats-news-caption">
                                    <div class="row">
                                    <c:forEach items="${listlife }" var="i">
                                    	<div class="col-lg-6 col-md-6">
                                            <div class="single-what-news mb-100">
                                                <div class="what-img">
                                                    <img src=${i.image } alt="">
                            ...
                            <div class="tab-pane fade" id="nav-last" role="tabpanel" aria-labelledby="nav-last-tab">
                                <div class="whats-news-caption">
                                    <div class="row">
                                    <c:forEach items="${listfashion }" var="i">
                                    	<div class="col-lg-6 col-md-6">
                                            <div class="single-what-news mb-100">
                                                <div class="what-img">
                                                    <img src=${i.image } alt="">
                            ...
                            <div class="tab-pane fade" id="nav-nav-Sport" role="tabpanel" aria-labelledby="nav-Sports">
                                <div class="whats-news-caption">
                                    <div class="row">
                                    <c:forEach items="${listsport }" var="i">
                                    	<div class="col-lg-6 col-md-6">
                                            <div class="single-what-news mb-100">
                                                <div class="what-img">
                                                    <img src=${i.image } alt="">
                            ...
                            <div class="tab-pane fade" id="nav-techno" role="tabpanel" aria-labelledby="nav-technology">
                                <div class="whats-news-caption">
                                    <div class="row">
                                    <c:forEach items="${listtech }" var="i">
                                    	<div class="col-lg-6 col-md-6">
                                            <div class="single-what-news mb-100">
                                                <div class="what-img">
                                                    <img src=${i.image } alt="">
                        ...
                        <nav aria-label="Page navigation example">
                            <ul class="pagination justify-content-start">
                              ...
                              <c:forEach begin="1" end = "${a.numberPage }" var="i">
                              	<li class="page-item"><a class="page-link" href="trang-chu?index=${i }">${i }</a></li>
                              </c:forEach>
                        ...
                        <div class="single-footer-caption">
                            <div class="single-footer-caption">
                                ...
                                <div class="footer-logo">
                                    <a href="trang-chu"><img src="assets/img/logo/logo2_footer.png" alt=""></a>
                                </div>
