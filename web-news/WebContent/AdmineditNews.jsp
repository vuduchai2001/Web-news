							...
							<div class="col-xs-12">
								...
								<c:forEach items="${list }" var="i">
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" name="text1" value="${i.caption }" required class="col-xs-10 col-sm-5" />
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" value="${i.category }" name="text2" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<textarea required="${i.detailssss }"  name="text4" class="col-xs-10 col-sm-5"></textarea>
										</div>
									</div>
